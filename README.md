...
- `build.py` — recompiles the DB + JSON from the `data/*.json` topic files.
- `data/*.json` — source content, one file per topic group.
...
## Regenerate / extend
Add or edit entries in `data/*.json`, then run `python3 build.py`.
